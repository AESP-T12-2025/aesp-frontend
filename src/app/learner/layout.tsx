    ...
    <div className="flex min-h-screen bg-[#F9FAFB]">
      ...
      <aside className="w-64 bg-white border-r border-gray-200 fixed h-full flex flex-col z-20 shadow-sm">
        ...
        <div className="p-4 border-t border-gray-50">
          <button className="w-full flex items-center gap-3 px-4 py-3 text-gray-400 hover:text-red-500 font-medium transition-colors">
            <span>🚪</span> Đăng xuất
          </button>
        </div>
      </aside>
      ...
      <div className="flex-1 ml-64 flex flex-col min-h-screen">
        ...
        <header className="h-16 bg-white border-b border-gray-200 sticky top-0 z-10 px-8 flex items-center justify-between shadow-sm">
          <div className="flex items-center gap-8 flex-1">
            ...
            {/* THANH TÌM KIẾM - Giống Admin Dashboard */}
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3 pl-6 border-l border-gray-200">
              <div className="text-right hidden sm:block">
                <p className="text-sm font-bold text-gray-900 leading-none">Long Học Viên</p>
        ...
        {/* 4. FOOTER - Cố định dưới đáy, thiết kế chuẩn mẫu */}
